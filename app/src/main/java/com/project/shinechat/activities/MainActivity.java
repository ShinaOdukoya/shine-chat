...
import com.project.shinechat.adapter.RecentConversationAdapter;
import com.project.shinechat.databinding.ActivityMainBinding;
import com.project.shinechat.listeners.ConversionListener;
import com.project.shinechat.models.ChatMessage;
import com.project.shinechat.models.User;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void updateToken(String token){
        ...
        documentReference.update(Constants.KEY_FCM_TOKEN, token)
                //.addOnSuccessListener(unsued -> showToast("Token updated successfully"))
